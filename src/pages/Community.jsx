import CommunityDoted from '../component/CommunityDoted'
...
const Community = () => {
  return (
      <div className='w-full h-full'>
          <div>
              <Title title="Community" place="Our mixed-use space hosts" time="ongoing events,podcasts & artists in residence" />
          </div>
          <div>
              <div className="flex justify-between mt-[100px] ">
                  <div className="">
                      <p className=" items-start text-[150px] flex-col flex "><span>Canal St.</span>
                      <span>Community</span></p>
                  </div>
                  <div className='w-[40%]'>
                     
                      <p className="text-[80px]">文化</p>
                  </div>
              </div>
          </div>
          <div className='grid grid-cols-3 gap-10 mt-[50px]'>
              <div className='w-[70%]  justify-center items-center '>
                  ...
                  <div className='flex flex-col items-center justify-center mt-4 mb-10'>
                      ...
                      <span>Retail Pop Up</span>
                      <span>Weekend!</span>
                  </div>
                  <div className='single-events__item'></div>
                  <div className='flex flex-col items-center justify-center mt-4 mb-10'>
                      <p>12/11 (past)</p>
                      <p>Hack City 12/11</p>
                  </div>
              ...
              <div className=''>
                  <div className=''>
                      <div className='grid grid-cols-2 gap-10'>   <div className='single-events__item'></div>
                          <div className='single-events__item'></div></div>
                      <div className=' text-[100px] flex flex-col h-[320px]'>
                          <span>Market</span>
                          <span>Events</span>
                      </div>
                      <div className='grid grid-cols-2 gap-10'>   <div className='single-events__item'></div>
              ...
              <div className='w-[70%]  justify-center items-center'>
                  ...
                  <div className='flex flex-col items-center justify-center mb-10'>
                      <p>02/07 (past)</p>
                      <span>New Balance x </span>
                      <span>Paperboy paris by</span>
                      <span>Greenhouse @ Canal</span>
              ...
              <div className='single-radio'>
                  <div className="flex items-center justify-between mt-20">
                      ...
                      <div className="flex flex-col items-center">
                          <p className=" text-center text-[80px] font-bold flex flex-col"><span>Market</span><span>Radio</span></p>
                          <span>Podcasted from the market</span>
                      </div>
                      <div className="transition-all duration-500 transform animate-bounce">
                          <div className="rotate-180">  <svg width="117px" height="140px" viewBox="0 0 117 140" version="1.1" xmlns="http://www.w3.org/2000/svg" >
                              <g id="R2" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                                  <g id="1440_community" transform="translate(-386.000000, -3535.000000)" fill="#000000" fillRule="nonzero">
                                      <g id="Group-15" transform="translate(239.000000, 3173.000000)">
                                          <g id="Group-14" transform="translate(0.000000, 180.000000)">
